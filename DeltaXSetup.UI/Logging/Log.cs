...
namespace DeltaXSetup.UI.Logging
{
    ...
    public class Log
    {
        private static readonly Log _instance = new Log("default");
        public ILog monitoringLogger;
        protected static ILog debugLogger;

        public Log(string logger)
        {
            monitoringLogger = LogManager.GetLogger(logger);
            debugLogger = LogManager.GetLogger("DebugLogger");
            log4net.GlobalContext.Properties["LogFileName"] = logger;
